...
import com.dzung.runner.locationtracker.BuildConfig
import com.dzung.runner.locationtracker.data.model.WeatherData
import com.dzung.runner.locationtracker.data.network.OpenWeatherApi
    ...
    suspend fun getWeather(lat: Double, lon: Double): Result<WeatherData> = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val recommendation = when {
                ...
                desc.contains("thunderstorm", ignoreCase = true) -> context.getString(com.dzung.runner.locationtracker.R.string.weather_rainy)
                temp > 33 -> context.getString(com.dzung.runner.locationtracker.R.string.weather_hot)
                temp < 10 -> context.getString(com.dzung.runner.locationtracker.R.string.weather_chilly)
                desc.contains("snow", ignoreCase = true) -> context.getString(com.dzung.runner.locationtracker.R.string.weather_snowy)
                else -> context.getString(com.dzung.runner.locationtracker.R.string.weather_perfect)
            }
